...
<!---->
  ...
  <!-- Jquery --> 
      ...
      <script src="/assets/js/betting3.js"></script>
    ...
    function changeInnerHTML1() {
      ...
      <script>
         ...
         if(distance==1197 || distance==1194 || distance==1191 || distance==1188 || distance==1185){
         generateGameid();
         getResultbyCategory('parity','parity');
         getResultbyCategory('sapre','sapre');
         getResultbyCategory('bcone','bcone');
