               ...
               <h5>
                  ...
                  <div class="histi">
                      <div class="himg">
                          ...
                          <?php 
$periodQuery = mysqli_query($con, "SELECT * FROM `tbl_result2` ORDER BY `id` DESC LIMIT 5;");
$periodData = array();
...
<!---->
  ...
  <!-- Jquery --> 
      ...
      <script src="/assets/js/betting2.js"></script>
    ...
    function changeInnerHTML1() {
      ...
      <script>
         ...
         if(distance==597 || distance==594 || distance==591 || distance==588 || distance==585){
         generateGameid();
         getResultbyCategory('parity','parity');
         getResultbyCategory('sapre','sapre');
         getResultbyCategory('bcone','bcone');
