...
<html lang="en">
   ...
   <body>
      ...
      <div class="appHeader1">
         ...
         <div class="pageTitle">Historical Betting</div>
      </div>
      <ul class="nav nav-tabs size4" id="myTab3" role="tablist">
         <li class="nav-item"> 
            <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#level1" role="tab">Wingo</a> 
         </li>
         <li class="nav-item"> 
            <a class="nav-link" id="profile1-tab3" data-toggle="tab" href="#level2" role="tab">Winzo</a>
         </li>
         <li class="nav-item"> 
            <a class="nav-link" id="profile2-tab3" data-toggle="tab" href="#level3" role="tab">D&T</a>
         </li>
         <li class="nav-item"> 
            <a class="nav-link" id="profile3-tab3" data-toggle="tab" href="#level4" role="tab">Jungle</a>
         </li>
      </ul></div>
            ...
            <div class="tab-pane fade active show" id="level1" role="tabpanel">
               <div class="newconatiner">
                  <div class="appContent1 listView">
                           ...
                           <tr class="betbox">
                              <td>
                                 <div class="">
                                    <div class="text">
                                       <div>
                                          <span style="background:#DB1918;padding:3px 5px;color:#fff;font-size:16px">1min</span>
                                          <p style="padding:4px 0px"></p>
                                          <span style="font-weight:400; font-size:19px;" ><?php echo $summeryResult['amount'];?></span>
                                          <p style="padding:2px 0px"></p>
                                          <span style="font-weight:400; font-size:16px;color:#9697A6"><?php echo $convert;?></span>
                                       </div>
                                    </div>
                                 </div>
                              </td>
                              <td class="tdtext2">
                                 <span style="color:#000" onclick="copy(this)">  <?php $new = $summeryResult['id'];  
                                    echo $convert1; echo $new; ?> <i style="padding-left:5px; font-size:16px;" class="fa fa-clone"></i></span>
                                 <p style="padding:2px 0px"></p>
                                 <span style="font-weight:400; font-size:19px;">-<?php echo number_format($summeryResult['amount'],2);?></span>
                              </td>
                           </tr>
                           ...
                           <tr class="betbox">
                              <td>
                                 <div class="">
                                    <div class="text">
                                       <div>
                                          <span style="background:#DB1918;padding:3px 5px;color:#fff;font-size:16px">5min</span>
                                          <p style="padding:4px 0px"></p>
                                          <span style="font-weight:400; font-size:19px;" ><?php echo $summeryResult['amount'];?></span>
                                          <p style="padding:2px 0px"></p>
                                          <span style="font-weight:400; font-size:16px;color:#9697A6"><?php echo $convert;?></span>
                              ...
                              <td class="tdtext">
                                 <span style="color:#000" onclick="copy(this)">  <?php $new = $summeryResult['id'];  
                                    echo $convert1; echo $new; ?> <i style="padding-left:5px; font-size:16px;" class="fa fa-clone"></i></span>
                                 <p style="padding:2px 0px"></p>
                                 <span style="font-weight:400; font-size:19px;">+<?php echo number_format($summeryResult['paidamount'],2);?></span>
                              </td>
                           </tr>
                           <?php }}}else{?>
                           <tr>
                     ...
                     <?php   $total_bet1 = mysqli_query($con,"SELECT sum(amount) as total1 FROM `tbl_userresult1` where userid = '".$userid."' ");
