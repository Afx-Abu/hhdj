...
<html lang="en">
   ...
   <body style="background:#F9FAFB">
      ...
      <div class="inivite">
         <div class="parent1">
            <div style="margin-top:-25px" class="child1">
               <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://jk-eur.com/register.php?code=<?php echo user($con,'owncode',$userid);?>">
      ...
      <p style="display:none" id="p2">https://jk-eur.com/register.php?code=<?php echo user($con,'owncode',$userid);?></p>
