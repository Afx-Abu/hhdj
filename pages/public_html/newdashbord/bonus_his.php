  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <section class="content">
                    ...
                    <div class="box">
                       ...
                       <th>Wallet</th>
                        ...
                        <th>Date</th>
                                    ...
                                    <tbody>
                                    <?php
                                    $Query=mysqli_query($con,"select * FROM tbl_bonus where amount > 50 limit 500 ");
                                    $i=0;
            ...
            <td><?php echo round($row["level1"],2); ?></td>
            <td><?php echo round($row["level2"],2); ?></td>
            <td><?php echo round($row["level3"],2); ?></td>
