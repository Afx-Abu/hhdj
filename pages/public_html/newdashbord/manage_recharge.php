...
<html>
   <head>
      ...
      <title>Admin Panel | Manage Recharge Waiting</title>
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
                  <h4 class="table_bg ">Manage Recharge Waiting</h4>
               <br></br>
               <ol class="breadcrumb">
                  <li><a href="desktop.php"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li class="active">Manage Recharge Waiting</li>
               </ol>
            </section>
            <!-- Main content -->
                              ...
                              <table id="example1" class="table table-striped">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $Query=mysqli_query($con,"select * from `nowpayment` where `payment_status`='waiting' order by id desc ");
                                       $i=0;
                                       $total=0; 
