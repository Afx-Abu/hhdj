                        ...
                        <div class="box-body" style="overflow-x:auto;">
                           <form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
                              ...
                              <table id="example1" class="table table-striped text-center">
                                 ...
                                 <ul><h4 style="margin-left:-20px;"> Peroid: <?php  $link =  $_GET['gameid']; echo $link;?><h4>
                                   <li>  Result: <?php  echo $_GET['result']; echo "&nbsp;"; echo $_GET['color'];?></li>
                                   <li>    Total Users: <?php  echo $_GET['totaluser'];?></li>
                                 ...
                                 <tbody>
                                    <?php
                                       $result = mysqli_query($con,"SELECT value , count( userid) as 'all_users', sum(amount) as 'total_amount' FROM tbl_betting where periodid = $link group by value");
                                       ?>
                                    <?php
                        ...
                        <div class="box-body" style="overflow-x:auto;">
                           <form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
                              ...
                              <table id="example2" class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    <?php
                                       $Query=mysqli_query($con,"select * FROM tbl_betting where periodid = $link  ");
                                       $i=0;
