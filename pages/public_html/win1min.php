         ...
         <div class="uppertbox">
            <div class="timebox">
               ...
               <ul style="margin-top:-40px;" class="nav nav-tabs1 size4">
                  <li class="nav-item1"> 
                     <a class="nav-link1"><i style="background: hsla(0,0%,100%,.8);padding:7px;border-radius:50%;height:30px;margin-top:-3px;color:red;font-size:22px;" class="fa fa-question-circle"></i></a> 
                  </li>
                  <li class="nav-item1"> 
               ...
               <ul style="" class="nav nav-tabs1 size4">
                   <li class="nav-item1"> 
                     ...
                     <span style="color:red; font-weight:700;">1 min</span>
                     </a> 
                  </li>
                    <li class="nav-item1"> 
                     <a style=" display: grid;line-height:5px" class="nav-link1" <a href="win.php">
                     ...
                     <span style="color:green; font-weight:700;">5 min</span>
                     </a> 
                  </li>
                  <li class="nav-item1"> 
                     <a style=" display: grid;line-height:5px" class="nav-link1">
      ...
      <div class="peroidbox">
         <div class="layout box">
            <div class="gameidtimer">
               <h6 class="mb-1 textwhite" style="font-size:12px;; font-weight:400; border-radius:5px; border:1px solid white; padding:5px; width:65%;text-align:center;margin-left:1px;">1 minute</h6>
               <h5>
                  <span class="showload">
         ...
         <div   class="modal-dialog" role="document">
            <div style="border-top-left-radius: 20px;
               ...
               <div class="modal-header paymentheader" id="paymenttitle">
                  <h4 class="modal-title" >1 minute</h4>
                  ...
                  <div style="margin:0px -18px -20px -18px" class="modal-body" id="loadform">
                     ...
                     <div class="container mt-1">
                        ...
                        <div class="right-group">
                           ...
                           <input type="radio" class="contract" name="optradio" id="hoursofoperation" value="1">1</label>
