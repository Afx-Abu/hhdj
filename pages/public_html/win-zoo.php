...
<html lang="en">
   <head>
      ...
      <style>
         ...
         box-shadow: 0 0 0px 0px rgb(207 0 69 / 10%);
         }
         .btns{
         border-radius: 5px; height:40px; font-weight: 500; font-size: 14px;  
         width: 155px;
         margin: 0 auto;
         border: 1px solid #FFED33;
         color: #000;
         ...
         width:100px;
         border-radius:15px;
         box-shadow: 0 0 0.21333rem 0.02667rem rgb(14, 231, 240 / 58%);
         }
         .back_three{
         ...
         box-shadow: 0 0 0.21333rem 0.02667rem rgb(255, 197, 17 / 100%);
         }
         .back_small{
         background: #5CBA47;
         color: #fff;
...
.btn4 img {
  ...
  height: 50px;
   border-radius: 50%;
         ...
         color: #fff;
         transition: 0.5s;
         background: linear-gradient(to right bottom, #ff8c00 50%, #17B3D4 50%);
         border: 2px solid white; 
         outline: 1px solid red;
         font-size:20px;
  ...
  height: 50px;
   border-radius: 50%;
         ...
         color: #fff;
         transition: 0.5s;
         background : linear-gradient(to right bottom, #4caf50 50%, #17B3D4 50%);
         border: 2px solid white; 
         outline: 1px solid green;
         font-size:20px;
   ...
   <body style="background-color:#FAFBFC">
      ...
      <div id="header" class="appHeader1">
         ...
         <div style="font-size:25px; font-weight:500" class="pageTitle">JK EUR</div>
         <div class="right ">
            <a href="main.php" class="icon goBack"> <img  src="images/icons/headphone.png" class="back"> </a>
         </div>
      </div>
      <!-- App Header -->
      <div class="headban">
               ...
               <div>
                  <div  class="">
                     ...
                     <div style="margin-top:20px;">
                        ...
                        <p style="float:right;color:#000; font-size:22px; font-weight:500;margin-top:-40px;" >TRX<span id="balance" ><?php echo number_format(wallet($con,'amount',$userid), 2);?></span> <a href="javascript:void(0);" onClick="reloadbtn(<?php echo $userid;?>);"><img class="walletimg1" id="spin-image" src="images/brefresh.png"></a></p>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="walletbox">
            <div class="box">
               <div class="layout">
                  <div  class="col-6 text-center">  <a style=""  href="withdrawals.php" class="btnss btn"> Withdraw</a></div>
                  <div class="col-6 text-center">
                     <a class="btns btn" href="recharges.php">Recharge</a>
                  </div>
               </div>
               <p></p>
            </div>
            ...
            <div class="timebox">
               ...
               <ul style="" class="nav nav-tabs1 size4">
                  <li class="nav-item1"> 
                     ...
                     <img style="height:20px;padding-left:7px" src="images/greentimer.png">
      ...
      <div class="bet">
         <div class="box">
            <div class="btn_center">
               <button type="button"  class="back_one gbutton" onClick="betbutton('#1DCC70','button','Green');">Beast</button>
               <button type="button" class="back_two gbutton" onClick="betbutton('#17B3D4','button','Violet');">Shark</button>
               <button type="button" class="back_three gbutton" onClick="betbutton('#ff8c00','button','Red');">Bird</button>
            </div>
            <div class="long  mt-1">
               <div class="appContent1 mt-n1">
                  <div class="container-fluid">
                     <div class="layout text-center  d-flex justify-content-center">
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn3" onClick="betbutton('#ff8c00','button','0');"> <img src="zoorullete/0.png" alt="Button Image"></button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="numbutton" class="btn   gbutton none btn5" onClick="betbutton('#1DCC70','button','1');"><img src="zoorullete/1.png" alt="Button Image"></button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn  gbutton none btn6" onClick="betbutton('#ff8c00','button','2');"><img src="zoorullete/2.png" alt="Button Image"></button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn5" onClick="betbutton('#1DCC70','button','3');"><img src="zoorullete/3.png" alt="Button Image"></button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn6" onClick="betbutton('#ff8c00','button','4');"><img src="zoorullete/4.png" alt="Button Image"></button>
                        </div>
                     </div>
                     <div class="layout text-center  mt-2 d-flex justify-content-center">
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn4" onClick="betbutton('#1DCC70','button','5');"><img src="zoorullete/5.png" alt="Button Image"> </button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn6" onClick="betbutton('#ff8c00','button','6');"><img src="zoorullete/6.png" alt="Button Image"></button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn5" onClick="betbutton('#1DCC70','button','7');"><img src="zoorullete/7.png" alt="Button Image"> </button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn6" onClick="betbutton('#ff8c00','button','8');"><img src="zoorullete/8.png" alt="Button Image"></button>
                        </div>
                        &emsp;
                        <div class="divsize2">
                           <button type="button" class="btn   gbutton none btn5" onClick="betbutton('#1DCC70','button','9');"><img src="zoorullete/9.png" alt="Button Image"></button>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <ul class="nav nav-tabs2 size2" id="myTab3" role="tablist">
         <li class="nav-item2"> 
            <a class="nav-link2 active" id="home-tab3" data-toggle="tab" href="#parity" role="tab" onClick="tabname('parity');getResultbyCategoryzoo('parity','parity');">Game Record</a> 
         </li>
        <!-- <li class="nav-item2"> 
            <a class="nav-link2" id="chart-tab3"  data-toggle="tab" href="#bcone" role="tab" onClick="getResultbyCategoryzoo('bcone','bcone');">Chat tren</a>
         </li>-->
         <li class="nav-item2"> 
            <a class="nav-link2" id="profile-tab3" data-toggle="tab" href="#sapre" role="tab" onClick="getResultbyCategoryzoo('sapre','sapre');">My Game Record</a>
         </li>
      </ul>
      <div>
      ...
      <script>
       ...
       <script>
         ...
         if(distance==177 || distance==174 || distance==171 || distance==168 || distance==165){
         generateGameid();
         getResultbyCategory('parity','parity');
         getResultbyCategory('sapre','sapre');
         getResultbyCategory('bcone','bcone');
         ...
         function getResultbyCategoryzoo(category,containerid)
         { 
         $.ajax({
         type: "Post",
         data:"category=" + category,
         url: "getResultbyCategoryzoo.php",
         success: function (html) {
