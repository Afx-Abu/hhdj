...
<html lang="en">
   ...
   <body>
      ...
      <div id="header" class="appHeader1">
         ...
         <div class="pageTitle">Deposit USDT</div>
      </div>
      <!-- * App Header --> 
      <div style="background-image: linear-gradient(to right, #CF0506 , #F4443E); height:50px;margin-top:55px;"></div>
      <!-- App Capsule -->
      <div id="appCapsule">
         <div class="appContent1 mb-5">
            ...
            <div class="layout bankcard">
               ...
               <div onclick="document.location='/recharges.php'" class="box">
                  <i class="icon ion-md-wallet"></i>
                  <p>TRON Pay</p>
               </div>
            </div>
             <div class="header1">
               <div class="header1-title">
                  <img src="images/reftickwallet.png"><span>Fast USDT</span>
               </div>
            </div>
      ...
      <script src="assets/js/paymenttron.js.php"></script>
      <?php  include("assets/js/paymenttron.js.php");?>
          <script>
