      ...
      <div id="appCapsule">
         <div class="appContent1">
            ...
            <div class="layout bankcard">
              <!-- <div onclick="document.location='/withdrawal.php'" class="box">
            ...
            <form  action="#" id="paymentForm" method="post" class="" autocomplete="off">
               <div class="boxinput mt-1 mb-1">
                  <div class="underinput">
                     ...
                     <input required style="padding-left: 20px;width:100%; font-size:17px;font-weight:600 " type="number" id="userammount" name="userammount" class=" textbox" placeholder="Please Enter Amount" onKeyPress="return isNumber(event)" min="<?php echo minamountsetting($con,'withdrawalamount');?>" maxlength="6">
                  </div>
               </div>
               <!-- <div class="fee">
