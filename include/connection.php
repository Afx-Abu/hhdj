...
{
    // $sql_curr    = "select curr from `site_setting` where `id`='1'";
    // $query_curr  = mysqli_query($con, $sql_curr);
    // $curr_result = mysqli_fetch_array($query_curr);
    // $curr= $curr_result['curr'];
...
function userpromocodeusdt($a, $userid, $code, $tradeamount, $periodid)
{
    ...
    //===============================================================================================
    $userlevel3Query=mysqli_query($a,"select `id` from `tbl_user` where `owncode`='".$level2code."'");
    ...
    $walletResult=mysqli_fetch_array($selectwallet);
   $sql= mysqli_query($a,"INSERT INTO `tbl_bonussummery`(`userid`,`periodid`,`level1id`,`level2id`,`level3id`,`level1amount`,`level2amount`,`level3amount`,`tradeamount`,`curr`,`createdate`) VALUES ('".$userid."','".$periodid."','".$level1id."','".$level2id."','".$level3id."','".$level1."','".$level2."','".$level3."','".$tradeamount."','usdt','".$today."')");
    
 
    $sqlbonuslevel1 = mysqli_query($a, "UPDATE `tbl_bonus` SET `amountusdt` = amountusdt+$level1,`level1usdt` = level1usdt+$level1 WHERE `userid`= $level1id");
    $sqlbonuslevel2 = mysqli_query($a, "UPDATE `tbl_bonus` SET `amountusdt` = amountusdt+$level2,`level2usdt` = level2usdt+$level2 WHERE `userid`= $level2id");
    $sqlbonuslevel3 = mysqli_query($a, "UPDATE `tbl_bonus` SET `amountusdt` = amountusdt+$level3,`level3usdt` = level3usdt+$level3 WHERE `userid`= $level3id");
    
    $sqlbonuslevel7=mysqli_query($a,"UPDATE `tbl_wallet` SET `amountusdt` = amountusdt+$level1 WHERE `userid`= '".$level1id."'");
    $sqlbonuslevel8=mysqli_query($a,"UPDATE `tbl_wallet` SET `amountusdt` = amountusdt+$level2 WHERE `userid`= '".$level2id."'");
    $sqlbonuslevel9=mysqli_query($a,"UPDATE `tbl_wallet` SET `amountusdt` = amountusdt+$level3 WHERE `userid`= '".$level3id."'");
...
function userpromocode($a, $userid, $code, $tradeamount, $periodid)
{
    ...
    $selectwallet=mysqli_query($a,"select * from `tbl_wallet` where `userid`='".$userid."'");
    $walletResult=mysqli_fetch_array($selectwallet);
   $sql= mysqli_query($a,"INSERT INTO `tbl_bonussummery`(`userid`,`periodid`,`level1id`,`level2id`,`level3id`,`level4id`,`level5id`,`level6id`,`level1amount`,`level2amount`,`level3amount`,`level4amount`,`level5amount`,`level6amount`,`tradeamount`,`curr`,`createdate`) VALUES ('".$userid."','".$periodid."','".$level1id."','".$level2id."','".$level3id."','".$level4id."','".$level5id."','".$level6id."','".$level1."','".$level2."','".$level3."','".$level4."','".$level5."','".$level6."','".$tradeamount."','trx','".$today."')");
