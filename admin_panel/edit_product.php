...
$role=mysqli_fetch_array($query);}?>
  ...
  <div class="content-wrapper">
   ...
   <textarea class="form-control" id="name" name="name" type="text" required ><?php echo $role['name'];?></textarea>
                </div>
                </div>
                 <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="form-group">
    ...
    <input class="form-control"  id="price" name="price" type="text" value="<?php echo $role['price'];?>">
         ...
         <input class="form-control"  id="images" name="images" type="file" name="file" accept="image/*" required value="<?php echo $role['images'];?>" >
