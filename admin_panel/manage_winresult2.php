 ...
 ?>
       ...
       <!-- <label>Sapre <br><input type="radio" class="tabbtn" name="tab" value="sapre" <?php if($role['tab']=='sapre'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <input type="radio" class="switchbutton" name="switch" id="switchno" value="no" <?php if($role['switch']=='no'){echo"checked";} ?>> No </label>
            ...
            <center> <b style="padding-left: 20px;">Note: </b><label style="color: red; padding-right: 30px;">Don't Close or Change Page After Raising Manual Result, wait For 4:45 Countdown Timer.</label> <a target="_blank" href="current_game_report2.php" style="background-color:darkorange; color: white; padding: 5px;">Live Reports</a></center>
            <!-- /.box-header -->
