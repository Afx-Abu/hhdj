...
<?php include ("include/header.inc.php");?>
 <?php include ("include/navigation.inc.php");?>
   ...
   <textarea class="form-control" id="name" name="name" type="text" value="" required></textarea>
                </div>
                </div>
                 <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="form-group">
    ...
    <input class="form-control"  id="price" name="price" type="text" value="" required>
         ...
         <input class="form-control"  id="images" name="images" type="file" name="file" accept="image/*" required>
