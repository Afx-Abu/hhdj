                        ...
                        <div class="box-body">
                            <form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                    $Query=mysqli_query($con,"select * from `tbl_userresult1` ORDER BY id DESC ");
                                    $i=0;
                                    while($row=mysqli_fetch_array($Query)){$i++;?>
                                       ...
                                       <td style="color:<?php if($row["status"]=='success'){echo"#1DCC70";}elseif($row["status"]=='fail'){echo"#ff2d55";}?>"><?php echo @$row["status"]; ?></td>
