...
$percentprofit=$netprofit*100/$total;
	  ...
	  ?>  
              ...
              <td><a href="checkperoid.php?gameid=<?php echo $row['periodid'];?>&&result=<?php if($row["resulttype"]=='random'){echo @$row["randomresult"];}else{echo @$row["result"];} ?>&&color=<?php if($row["resulttype"]=='random'){echo strtoupper(@$row["randomcolor"]);}else{echo strtoupper(@$row["color"]);} ?>&&totaluser=<?php echo @$num; ?>&&amount=<?php echo number_format(@$total,2); ?>"><?php echo $row['periodid'];?></a></td>
