...
<div class="wrapper">
  <?php include ("include/connection3.php");?>
...
<div id="overlay"></div>
 ...
 ?>
             ...
             <label>Manual <br><input type="radio" class="tabbtn" name="tab" value="parity" <?php if($role['tab']=='parity'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- <label>Sapre <br><input type="radio" class="tabbtn" name="tab" value="sapre" <?php if($role['tab']=='sapre'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <input type="radio" class="switchbutton" name="switch" id="switchno" value="no" <?php if($role['switch']=='no'){echo"checked";} ?>> No </label>
            ...
            <center> <b style="padding-left: 20px;">Note: </b><label style="color: red; padding-right: 30px;">Don't Close or Change Page After Raising Manual Result, wait For 4:45 Countdown Timer.</label> <a target="_blank" href="current_game_report3.php" style="background-color:darkorange; color: white; padding: 5px;">Live Reports</a></center>
            <!-- /.box-header -->
...
var countDownDate = Date.parse(new Date) / 1e3;
  ...
  var distance = 1200 - countDownDate % 1200;
  //alert(distance);
  var i = distance / 60,
   n = distance % 60,
   o = n / 10,
